    ...
    return (
        <div className={styles.parentContainer}>
            <div className={styles.headerContainer}>
                <h1>Create Geos</h1>
                <p>Select a point on the map, a radius and a start and end date to allow users to check in!</p>
            </div>
            <div className={styles.mapContainer}>
                <div className={styles.mapPicker}>
                    <MapPicker onCoordinateSelect={handleCoordinateSelect} radius={selectedRadius} />
                </div>
            </div>
